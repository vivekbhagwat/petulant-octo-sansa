...
get '/projects' do
  projects = '''
Sofia is currently the PSM for <i>Kings</i> directed by Adrienne Campbell-Holt and written by Sarah Burgess at the Women\'s Project and is available for other opportunities.
'''
...
get '/resume' do
  image = "http://i.imgur.com/rUPAw6O.png"
